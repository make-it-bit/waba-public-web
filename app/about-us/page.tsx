  ...
  return (
    <>
      <AboutScienceHero
        ...
        image={getImageFullUrl_server(aboutPageData.attributes.hero.background_image.data)}
      />
      ...
      <TextImage
        ...
        image={getImageFullUrl_server(aboutPageData.attributes.text_image_1.image.data)}
        imageSide="right"
      />
      ...
      <TextImage
        ...
        image={getImageFullUrl_server(aboutPageData.attributes.text_image_2.image.data)}
        imageSide="left"
      />
