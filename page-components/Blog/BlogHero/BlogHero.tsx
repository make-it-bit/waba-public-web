    ...
    <div className="container mt-64 mb-40">
      <div className="grid grid-cols-12 gap-x-32">
        <div className="lg:col-start-4 lg:col-span-6 col-span-12 text-center">
          ...
          <h1 className="font-rufina text-5xl leading-5xl lg:mb-88 md:mb-64 mb-40">{blogHeroData.title}</h1>
        </div>
        <div className="lg:col-start-2 lg:col-span-5 md:col-span-6 col-span-12">
          <Link href={blogHeroData.featured_blog_post.data.attributes.slug}>
        ...
        <div className="lg:col-span-5 md:col-span-6 col-span-12">
          <div className="flex flex-col justify-end h-full text-justify">
            ...
            <Link href={blogHeroData.featured_blog_post.data.attributes.slug}>
              <h2 className="font-rufina text-4xl leading-4xl my-16">
