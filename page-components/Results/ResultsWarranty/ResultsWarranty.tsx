          ...
          <div className="col-span-12">
            ...
            >
              <video
                ...
                loop
                className={classNames(
                  'absolute bottom-0 lg:left-[-400px] md:left-[-280px] w-full md:h-full md:object-cover object-contain md:inset-0 md:mix-blend-lighten mix-blend-darken z-[-1] sm:mb-0 mb-72',
                  styles.videoMargin
                )}
              >
