              ...
              <div className="flex flex-col">
                ...
                <div className="mt-5">
                  <div className="flex flex-row items-center pb-2">
                    ...
                    <div>
                      <p className="text-2sm ml-2">Blue or red only light mask +€690</p>
                    </div>
                  </div>
                  <div className="flex flex-row items-center pb-2">
                    <div>
                    ...
                    <div>
                      <p className="text-2sm ml-2">Decollatage mask +€690</p>
                    </div>
                  </div>
                  <div className="flex flex-row items-center pb-2">
                    <div>
                    ...
                    <div>
                      <p className="text-2sm ml-2">Hand mask +€690</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-12">
            ...
            <div className="col-span-4  relative flex items-end">
              ...
              <div className="bg-black-100 px-2 p-2 absolute md:-bottom-[62px] md:-right-[20px] -right-[20px] z-10">
                <p className="text-sm md:text-2sm px-[10px] text-white-100">Total 2000+ EUR</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-12 gap-0">
            ...
            <div className="col-span-4 relative flex items-end">
              ...
              <div className="bg-black-100 px-2 p-2 absolute bottom-0 right-0 z-10">
                <p className="text-sm md:text-2sm px-[10px] text-white-100">Total 475 EUR</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-12">
            ...
            <div className="col-span-6 relative flex flex-col pl-10 py-10">
              ...
              <div className="absolute -bottom-[10px] md:-bottom-[90px] right-0">
                <p className="text-sm">*Yearly cost, in €EUR</p>
              </div>
            </div>
          </div>
        </div>
