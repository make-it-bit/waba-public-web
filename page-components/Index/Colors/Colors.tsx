  ...
  return (
    <div className="container">
      <div className="grid grid-cols-12 mb-88">
        <div className="col-start-4 col-end-10 text-center mt-160 mb-144">
        ...
        <div className="col-start-1 col-span-4 flex flex-col justify-between">
          <div className="mb-48">
            <p className="text-sm">Blue head</p>
            <p className="text-xl">
              Removes skin imperfections - spots, inflammation and blemishes
            </p>
          </div>
          <div className="mb-48">
            <p className="text-sm">Red head</p>
            <p className="text-xl">
              Reduces fine lines + wrinkles and firm the skin
            </p>
          </div>
          <div>
            <p className="text-sm">Infrared head</p>
            <p className="text-xl">Revitalise and balance skin tone</p>
          </div>
        </div>
        <div className="col-start-9 col-span-5 flex flex-col justify-between">
          <p className="text-sm mb-56">
