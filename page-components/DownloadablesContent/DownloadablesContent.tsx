...
type DownloadablesContentProps = {
  logo?: any;
  intro_title?: string;
  main_title: string;
...
const DownloadablesContent = ({ downloadableData }: { downloadableData: DownloadablesContentProps }) => {
  const {
    logo,
  ...
  return (
    <div className="relative w-screen h-screen">
      <Image src={getImageFullUrl_client(bgImage.data)} fill alt="Downloadables" />
